...
sed -n '/Celltrace and UETRACE file generation/,/CellTrace for MMEs/p' /netsim/Ref_$1.txt | sed 's/#//g' >>celltrace1.txt
...
cat /netsim/Ref_$1.txt|grep "Node level load configuration"|sed 's/[ \t]*$//'>>LoadRef.txt
